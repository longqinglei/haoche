...
- (void)updateDots
{
    ...
    for (NSInteger i = 0; i < self.numberOfPages; i++) {
        ...
        if (i < self.dots.count) {
            dot = [self.dots HCObjectAtIndex:i];
        } else {
...
{
    if (self.dotViewClass) {
        TAAbstractDotView *abstractDotView = (TAAbstractDotView *)[self.dots HCObjectAtIndex:index];
        ...
        UIImageView *dotView = (UIImageView *)[self.dots HCObjectAtIndex:index];
