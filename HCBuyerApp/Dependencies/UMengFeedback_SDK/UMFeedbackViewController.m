...
- (void)updateLayoutWithOrientation:(UIInterfaceOrientation)orientation {
    ...
    switch (orientation) {
        ...
        case UIInterfaceOrientationPortraitUpsideDown: {
            CGFloat viewWidth ;//viewHeightt
            viewWidth = viewSize.width;
            //viewHeightt= viewSize.height;
...
//            [self.inputToolBar setNeedsLayout];
        ...
        case UIInterfaceOrientationLandscapeRight: {
            CGFloat viewWidth,  originY;//viewHeightt
            viewWidth = viewSize.width;
...
- (void)presentPhotoLibrary:(UIButton *)button
{
  ...
  //  [self presentModalViewController:imagePicker animated:YES]; //更改为新的方法
...
//    NSString *type = info[UIImagePickerControllerMediaType];
        ...
        || picker.sourceType == UIImagePickerControllerSourceTypeSavedPhotosAlbum)
    {
       ...
       // [picker dismissModalViewControllerAnimated:YES]; 更改新的方法
...
//                                   lineBreakMode:NSLineBreakByWordWrapping];
        CGSize labelSize = [content boundingRectWithSize:CGSizeMake(self.mTableView.frame.size.width - 40, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:14.0f],NSFontAttributeName, nil] context:nil].size;
