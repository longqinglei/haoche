...
//                                           lineBreakMode:NSLineBreakByWordWrapping];
    CGSize labelSize = [self.messageLabel.text boundingRectWithSize:CGSizeMake(215, MAXFLOAT) options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont systemFontOfSize:14.0f],NSFontAttributeName, nil] context:nil].size;
