...
{
    NSString *carRegex = @"^[A-HJ-Za-hj-z]{1}[A-Za-z_0-9]{5}$";
...
+ (BOOL) isChinaUnicomPhoneNumber:(NSString*) phonenumber
{
	/**
	 * 手机号码
	 * 移动：134[0-8],135,136,137,138,139,150,151,157,158,159,182,187,188,138
...
//			result = [IdentifierValidator isValidEmail:value];
        ...
        case IdentifierTypeBirthday:
            ...
            break;
        case IdentifierTypeCarNo:
            result = [IdentifierValidator isValidCarNo:value];
            break;
		default:
			break;
	}
