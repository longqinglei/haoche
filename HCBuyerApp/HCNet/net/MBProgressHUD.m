...
//								constrainedToSize:maxSize lineBreakMode:detailsLabel.lineBreakMode];
    CGRect tmpRect = [detailsLabel.text boundingRectWithSize:maxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:[NSDictionary dictionaryWithObjectsAndKeys:detailsLabel.font,NSFontAttributeName, nil] context:nil];
    CGSize detailsLabelSize = tmpRect.size;
